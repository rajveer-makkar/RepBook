  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-900 px-4">
      <div className="w-full max-w-sm">
        <h1 className="mb-1 text-2xl font-bold text-zinc-100">Create your account</h1>
        <p className="mb-6 text-sm text-zinc-400">Takes 20 seconds. Your program builds itself.</p>
